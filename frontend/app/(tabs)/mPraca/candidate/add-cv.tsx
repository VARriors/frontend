...
export default function AddCVScreen() {
  ...
  const handleGenerateCV = () => {
    router.replace('/(tabs)/mPraca/candidate/preferences');
  };
...
const styles = StyleSheet.create({
  ...
  title: { fontSize: 22, fontWeight: '700', color: '#1A1A1A', marginBottom: 24, lineHeight: 30 },
  card: { backgroundColor: '#F8F9FA', borderRadius: 16, padding: 20, borderWidth: 1, borderColor: '#EAECF0' },
  cardTitle: { fontSize: 18, fontWeight: '600', color: '#1A1A1A', marginBottom: 8 },
  cardDesc: { fontSize: 14, color: '#4A5568', lineHeight: 22, marginBottom: 20 },
  primaryButton: { backgroundColor: '#0052A5', paddingVertical: 14, borderRadius: 10, alignItems: 'center' },
  primaryButtonText: { color: '#FFFFFF', fontSize: 15, fontWeight: '600' },
  secondaryButton: { backgroundColor: '#FFFFFF', borderWidth: 1, borderColor: '#CBD5E1', paddingVertical: 14, borderRadius: 10, alignItems: 'center' },
  secondaryButtonText: { color: '#0052A5', fontSize: 15, fontWeight: '600' },
  separator: { alignItems: 'center', marginVertical: 24 },
  separatorText: { color: '#94A3B8', fontWeight: '700' }
});
